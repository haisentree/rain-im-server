...
type Client struct {
	...
	CreatedAt     *v1.Time               `protobuf:"bytes,3,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty" bun:"type:timestamptz"`
	UpdatedAt     *v1.Time               `protobuf:"bytes,4,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty" bun:"type:timestamptz"`
	DeletedAt     *v1.Time               `protobuf:"bytes,5,opt,name=deleted_at,json=deletedAt,proto3,oneof" json:"deleted_at,omitempty" bun:"type:timestamptz,soft_delete,nullzero"`
...
type ClientConversation struct {
	...
	ClientMax     *v1.UUID               `protobuf:"bytes,3,opt,name=client_max,json=clientMax,proto3" json:"client_max,omitempty" bun:"type:uuid"`
	Seq           uint64                 `protobuf:"fixed64,4,opt,name=seq,proto3" json:"seq,omitempty"`
	CreatedAt     *v1.Time               `protobuf:"bytes,5,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty" bun:"type:timestamptz"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ClientGroupConversation struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            *v1.UUID               `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" bun:"type:uuid,pk"`
	GroupId       *v1.UUID               `protobuf:"bytes,2,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty" bun:"type:uuid"`
	Seq           uint64                 `protobuf:"fixed64,3,opt,name=seq,proto3" json:"seq,omitempty"`
	CreatedAt     *v1.Time               `protobuf:"bytes,4,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty" bun:"type:timestamptz"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
