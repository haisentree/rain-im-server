...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/haisentree/rain-im-server/proto/gen/user/v1"
	http "net/http"
	strings "strings"
)
...
type UserServiceClient interface {
	GetUser(context.Context, *v1.GreetRequest) (*v1.GreetResponse, error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		getUser: connect.NewClient[v1.GreetRequest, v1.GreetResponse](
			httpClient,
...
type userServiceClient struct {
	getUser *connect.Client[v1.GreetRequest, v1.GreetResponse]
}

// GetUser calls user.v1.UserService.GetUser.
func (c *userServiceClient) GetUser(ctx context.Context, req *v1.GreetRequest) (*v1.GreetResponse, error) {
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *v1.GreetRequest) (*v1.GreetResponse, error) {
